...
api_router.register(r'ambtempforecast', photovoltaic_views.AmbientTemperatureForecastViewSet)
api_router.register(r'irradforecast', photovoltaic_views.IrradianceForecastViewSet)
api_router.register(r'pvtempforecast', photovoltaic_views.PVModuleTemperatureForecastViewSet)
