...
from photovoltaic.ai.registry import AIRegistry
import numpy as np
...
class AITests(SimpleTestCase):
    ...
    #    registry = AIRegistry()
    #    algorithm_object = LstmPowerForecaster()
    ...
    #    algorithm_availability = True
        ...
        # add to registry
    #    registry.add_algorithm(algorithm_object, algorithm_name,
    #                algorithm_description, algorithm_availability)
    #    # there should be one algorithms available
