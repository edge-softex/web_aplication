...
def instant_power_forecast(self, timestamp):
    ...
    print('Predicting the next 5 minutes of instant power:')

    prediction = algorithm_object.compute_prediction(input_data)
    
    print(f'Minute 1: {prediction[0]}')
    print(f'Minute 2: {prediction[1]}')
    print(f'Minute 3: {prediction[2]}')
    print(f'Minute 4: {prediction[3]}')
    print(f'Minute 5: {prediction[4]}')
